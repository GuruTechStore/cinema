...
<head>
    ...
    <title>@yield('title', 'CinePlanet')</title>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark" style="background: linear-gradient(135deg, var(--primary-blue), var(--secondary-blue));">
        <div class="container">
            <a class="navbar-brand d-flex align-items-center" href="{{ route('home') }}">
                <img src="{{ asset('images/logo.png') }}" alt="CinePlanet" class="me-2">
                <i class="fas fa-film text-warning fs-2 me-2"></i>
                <span class="fw-bold fs-4">CinePlanet</span>
            </a>
    ...
    <footer class="footer mt-5 py-5">
        <div class="container">
            <div class="row">
                <div class="col-lg-4 mb-4">
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <h5 class="text-white mb-0">CinePlanet</h5>
                    </div>
            ...
            <div class="text-center text-light">
                <p>&copy; {{ date('Y') }} CinePlanet. Todos los derechos reservados.</p>
